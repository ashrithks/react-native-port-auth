...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "PortAuthority";
        public static final String DATABASE_NAME_CLASS = "PortAuthorityClass";
    ...
    private boolean mIsDbUpdatedSuccessfully;
    ...
    private Database(Context context) {
        ...
        db = this.getWritableDatabase(DATABASE_NAME_CLASS);
    }
    ...
    public boolean isIsDbUpdatedSuccessfully() {
        return mIsDbUpdatedSuccessfully;
    }

    public void setIsDbUpdatedSuccessfully(boolean mIsDbUpdatedSuccessfully) {
        this.mIsDbUpdatedSuccessfully = mIsDbUpdatedSuccessfully;
    }
}
